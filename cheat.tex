...
\newcommand{\SVMOnl}{{
Online SVM is described in \emph{The Huller: A Simple and Efficient Online SVM}, Bordes \& Bottou (2005).
}}
...
\newcommand{\MGOnl}{{
Online estimation of Gaussian Mixture Models is described in \emph{Highly Efficient Incremental Estimation of Gaussian Mixture Models for Online Data Stream Clustering}, Song \& Wang (2005).
}}
