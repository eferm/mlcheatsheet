...
\newcommand{\MGOnl}{{
\raggedright
Online estimation of Gaussian Mixture Models is described in:
\newline

\emph{Highly Efficient Incremental Estimation of Gaussian Mixture Models for Online Data Stream Clustering}, Song \& Wang (2005).
}}
